 ...
 */
public class VsWord extends android.support.v4.app.Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle savedInstanceState) {
        ...
        p1Ques.setTextColor(colors[colorIndex1]);
        p2Ques.setText(questions[index2]);
        p2Ques.setTextColor(colors[colorIndex2]);
    ...
    private void shufflePositions1() {
        ...
        while (tempPositions[0] == index1) {
            tempPositions[0] = r.nextInt(7);
        }
        tempPositions[1] = r.nextInt(7);
        while (tempPositions[1] == index1 || tempPositions[1] == tempPositions[0]) {
            tempPositions[1] = r.nextInt(7);
        }
        tempPositions[2] = r.nextInt(7);
        while (tempPositions[2] == index1 || tempPositions[2] == tempPositions[1] || tempPositions[2] == tempPositions[0]) {
            tempPositions[2] = r.nextInt(7);
        }
        ...
        switch (shuffledPosition) {
            case 0:
                p1c1.setText(questions[index1]);
                p1c1.setBackgroundColor(colors[index1]);

                p1c2.setText(questions[tempPositions[0]]);
                p1c2.setBackgroundColor(colors[tempPositions[0]]);
                p1c3.setText(questions[tempPositions[1]]);
                p1c3.setBackgroundColor(colors[tempPositions[1]]);
                p1c4.setText(questions[tempPositions[2]]);
                p1c4.setBackgroundColor(colors[tempPositions[2]]);

                break;
            case 1:
                p1c2.setText(questions[index1]);
                p1c2.setBackgroundColor(colors[index1]);

                p1c1.setText(questions[tempPositions[0]]);
                p1c1.setBackgroundColor(colors[tempPositions[0]]);
                p1c3.setText(questions[tempPositions[1]]);
                p1c3.setBackgroundColor(colors[tempPositions[1]]);
                p1c4.setText(questions[tempPositions[2]]);
                p1c4.setBackgroundColor(colors[tempPositions[2]]);
                ...
                break;
            case 2:
                p1c3.setText(questions[index1]);
                p1c3.setBackgroundColor(colors[index1]);

                p1c2.setText(questions[tempPositions[0]]);
                p1c2.setBackgroundColor(colors[tempPositions[0]]);
                p1c1.setText(questions[tempPositions[1]]);
                p1c1.setBackgroundColor(colors[tempPositions[1]]);
                p1c4.setText(questions[tempPositions[2]]);
                p1c4.setBackgroundColor(colors[tempPositions[2]]);

                break;
            case 3:
                p1c4.setText(questions[index1]);
                p1c4.setBackgroundColor(colors[index1]);
                ...
                p1c1.setBackgroundColor(colors[tempPositions[2]]);
    ...
    private void shufflePositions2() {
        ...
        Random r = new Random();
        tempPositions[0] = r.nextInt(7);
        while (tempPositions[0] == index2) {
            tempPositions[0] = r.nextInt(7);
        }
        tempPositions[1] = r.nextInt(7);
        while (tempPositions[1] == index2 || tempPositions[1] == tempPositions[0]) {
            tempPositions[1] = r.nextInt(7);
        }
        tempPositions[2] = r.nextInt(7);
        while (tempPositions[2] == index2 || tempPositions[2] == tempPositions[1] || tempPositions[2] == tempPositions[0]) {
            tempPositions[2] = r.nextInt(7);
        }
        ...
        switch (shuffledPosition) {
            case 0:
                p2c1.setText(questions[index2]);
                p2c1.setBackgroundColor(colors[index2]);

                p2c2.setText(questions[tempPositions[0]]);
                p2c2.setBackgroundColor(colors[tempPositions[0]]);
                p2c3.setText(questions[tempPositions[1]]);
                p2c3.setBackgroundColor(colors[tempPositions[1]]);
                p2c4.setText(questions[tempPositions[2]]);
                p2c4.setBackgroundColor(colors[tempPositions[2]]);

                break;
            case 1:
                p2c2.setText(questions[index2]);
                p2c2.setBackgroundColor(colors[index2]);

                p2c1.setText(questions[tempPositions[0]]);
                p2c1.setBackgroundColor(colors[tempPositions[0]]);
                p2c3.setText(questions[tempPositions[1]]);
                p2c3.setBackgroundColor(colors[tempPositions[1]]);
                p2c4.setText(questions[tempPositions[2]]);
                p2c4.setBackgroundColor(colors[tempPositions[2]]);
                ...
                break;
            case 2:
                p2c3.setText(questions[index2]);
                p2c3.setBackgroundColor(colors[index2]);

                p2c2.setText(questions[tempPositions[0]]);
                p2c2.setBackgroundColor(colors[tempPositions[0]]);
                p2c1.setText(questions[tempPositions[1]]);
                p2c1.setBackgroundColor(colors[tempPositions[1]]);
                p2c4.setText(questions[tempPositions[2]]);
                p2c4.setBackgroundColor(colors[tempPositions[2]]);

                break;
            case 3:
                p2c4.setText(questions[index2]);
                p2c4.setBackgroundColor(colors[index2]);
                ...
                p2c1.setBackgroundColor(colors[tempPositions[2]]);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.player1choice1:
                if (questions[index1].equals(p1c1.getText().toString()))
                    nextQuestionPlayer1();
                else
                    gameOver(1);
                break;
            case R.id.player1choice2:
                if (questions[index1].equals(p1c2.getText().toString()))
                    nextQuestionPlayer1();
                else
                    gameOver(1);
                break;
            case R.id.player1choice3:
                if (questions[index1].equals(p1c3.getText().toString()))
                    nextQuestionPlayer1();
                else
                    gameOver(1);
                break;
            case R.id.player1choice4:
                if (questions[index1].equals(p1c4.getText().toString()))
                    nextQuestionPlayer1();
                else
                    gameOver(1);
                break;
            case R.id.player2choice1:
                if (questions[index2].equals(p2c1.getText().toString()))
                    nextQuestionPlayer2();
                else
                    gameOver(0);
                break;
            case R.id.player2choice2:
                if (questions[index2].equals(p2c2.getText().toString()))
                    nextQuestionPlayer2();
                else
                    gameOver(0);
                break;
            case R.id.player2choice3:
                if (questions[index2].equals(p2c3.getText().toString()))
                    nextQuestionPlayer2();
                else
                    gameOver(0);
                break;
            case R.id.player2choice4:
                if (questions[index2].equals(p2c4.getText().toString()))
                    nextQuestionPlayer2();
                else
                    gameOver(0);
                break;
