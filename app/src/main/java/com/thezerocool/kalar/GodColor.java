 ...
 */
public class GodColor extends Fragment implements View.OnClickListener {
    //For Scores:
...
//        scores = getActivity().getPreferences(Context.MODE_PRIVATE);
        ...
        currentColor = colorsx.getInt(questions[colorIndex], defaultValue);
    ...
    private void shufflePositions() {
        ...
        switch (shuffledPosition) {
            ...
            case 1:
                ...
                choice2.setBackgroundColor(colorsx.getInt(questions[tempPositions[1]], defaultValue));

                choice1.setText(questions[tempPositions[0]]);
                choice1.setBackgroundColor(colorsx.getInt(questions[colorIndex], defaultValue));
                choice3.setText(questions[tempPositions[1]]);
                choice3.setBackgroundColor(colorsx.getInt(questions[tempPositions[0]], defaultValue));
                choice4.setText(questions[tempPositions[2]]);
            ...
            case 2:
                ...
                choice1.setBackgroundColor(colorsx.getInt(questions[tempPositions[2]], defaultValue));
                choice4.setText(questions[tempPositions[2]]);
                choice4.setBackgroundColor(colorsx.getInt(questions[tempPositions[0]], defaultValue));
            ...
            case 3:
                ...
                choice2.setText(questions[tempPositions[0]]);
                choice2.setBackgroundColor(colorsx.getInt(questions[tempPositions[2]], defaultValue));
                choice3.setText(questions[tempPositions[1]]);
                choice3.setBackgroundColor(colorsx.getInt(questions[colorIndex], defaultValue));
    ...
    public void gameOver() {
        handler.post(new Runnable() {
            ...
            public void run() {
                try {
                    int temp = scores.getInt(GOD_COLOR_HIGH, 0);
                    highScoreValue = temp;
                    if (scoreValue >= temp) {
                        SharedPreferences.Editor editor = scores.edit();
                        editor.putInt(GOD_COLOR_HIGH, GodColor.scoreValue);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.backButton:
                ...
                break;
            case R.id.choice1:
                if (currentColor == ((ColorDrawable) choice1.getBackground()).getColor()) {
                    nextQuestion();
                } else {
                    gameOver();
                }
                break;
            case R.id.choice2:
                if (currentColor == ((ColorDrawable) choice2.getBackground()).getColor()) {
                    nextQuestion();
                } else {
                    gameOver();
                }
                break;
            case R.id.choice3:
                if (currentColor == ((ColorDrawable) choice3.getBackground()).getColor()) {
                    nextQuestion();
                } else {
                    gameOver();
                }
                break;
            case R.id.choice4:
                if (currentColor == ((ColorDrawable) choice4.getBackground()).getColor()) {
                    nextQuestion();
                } else {
                    gameOver();
                }
