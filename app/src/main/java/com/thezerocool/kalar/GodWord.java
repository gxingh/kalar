 ...
 */
public class GodWord extends Fragment implements View.OnClickListener {
    //For Scores:
...
//        scores = getActivity().getPreferences(Context.MODE_PRIVATE);
    ...
    private void shufflePositions() {
        ...
        switch (shuffledPosition) {
            ...
            case 2:
                ...
                choice4.setText(questions[tempPositions[0]]);
                choice4.setBackgroundColor(colors[tempPositions[2]]);
            ...
            case 3:
                ...
                choice2.setText(questions[tempPositions[2]]);
                choice2.setBackgroundColor(colors[tempPositions[0]]);
                choice3.setText(questions[index]);
                choice3.setBackgroundColor(colors[tempPositions[1]]);
    ...
    public void gameOver() {
        handler.post(new Runnable() {
            ...
            public void run() {
                try {
                    int temp = scores.getInt(GOD_WORD_HIGH, 0);
                    highScoreValue=temp;
                    if (scoreValue >= temp) {
                        SharedPreferences.Editor editor = scores.edit();
                        editor.putInt(GOD_WORD_HIGH, GodWord.scoreValue);
