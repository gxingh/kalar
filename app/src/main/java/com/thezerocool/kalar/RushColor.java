 ...
 */
public class RushColor extends Fragment implements View.OnClickListener {
...
//        scores = getActivity().getPreferences(Context.MODE_PRIVATE);
    ...
    public void gameOver() {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                try {
                    int temp = scores.getInt(RUSH_COLOR_HIGH, 0);
                    highScoreValue = temp;
                    if (scoreValue >= temp) {
                        SharedPreferences.Editor editor = scores.edit();
                        editor.putInt(RUSH_COLOR_HIGH, RushColor.scoreValue);
